...
\begin{document}
	...
	\section{Phasendiagramm }
		...
		\begin{frame}
			...
			\begin{block}{network}
				\begin{center}
				\includegraphics[width=0.5\textwidth]{network/chat_hi.png}\\
				\includegraphics[width=0.5\textwidth]{network/move.png}
				\includegraphics[width=0.5\textwidth]{network/deal.png}
			\end{center}
			\end{block}		
		\end{frame}
		%=======================================================
