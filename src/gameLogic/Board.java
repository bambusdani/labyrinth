...
public class Board {
    ...
    //TODO bei der Spielererstellung müssen die Daten aus dem Fenster davor übergeben werde
        ...
        allPlayers[0] = new Player(new Position(6,6), new Position(1,5), 0 , new Color(255, 0 ,0),      true,   0, "Rehan",    creaturesNeededPlayer1);
        allPlayers[1] = new Player(new Position(0,6), new Position(3,2), 1 , new Color(0, 0 ,255),      false,  6, "Marvin",   creaturesNeededPlayer2);
        allPlayers[2] = new Player(new Position(6,0), new Position(5,3), 2 , new Color(252, 255, 0),    false,  6, "Daniel",   creaturesNeededPlayer3);
