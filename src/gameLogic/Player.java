...
public class Player {
    ...
    private String[] cardSymbolNeeded;
    private Color color;
    ...
    /** KONSTRUKTOR */
    public Player(Position startPosition, Position actualPosition, int playerID, Color color, boolean turn, int score, String nameOfPlayer, String[]cardSymbolNeeded) {
    ...
    public String[] getCreaturesNeeded(){return cardSymbolNeeded;}  public void setCreaturesNeeded(String[] creaturesNeeded){this.cardSymbolNeeded=creaturesNeeded;}
